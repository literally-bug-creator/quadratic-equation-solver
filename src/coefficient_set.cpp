...
std::string unite_error_msgs( const std::string& a_msg,
                              const std::string& b_msg,
                              const std::string& c_msg ) {
...
std::string collect_error_msg( const Coefficient& a,
                               const Coefficient& b,
                               const Coefficient& c ) {
    ...
    std::string msgs =
        unite_error_msgs( a_error_msg, b_error_msg, c_error_msg );
...
Coefficient get_a( const CoefficientSet& coeffs ) { return coeffs.a; }

Coefficient get_b( const CoefficientSet& coeffs ) { return coeffs.b; }

Coefficient get_c( const CoefficientSet& coeffs ) { return coeffs.c; }
